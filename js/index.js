...
var userContacts;
    ...
    {
        userContacts = [];
        //_.sortBy(userContacts, 'userStatusInp')
    }
    else
    {
...
var userStatusInp = document.getElementById("userStatus");
...
function addContact()
{
    ...
    var contacts = { name:userNameInp.value , phone:userPhoneInp.value , email:userEmailInp.value , status:userStatusInp.value};
    
    if (contacts.status == "on"){
        userContacts.unshift(contacts);
